...
public class LeviosaSpellItem extends Item {
	public LeviosaSpellItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				LeviosaSpellEntity entityarrow = LeviosaSpellEntity.shoot(world, entity, world.getRandom(), 1f, 0, 0);
