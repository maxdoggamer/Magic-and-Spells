...
public class StupefySpellItem extends Item {
	public StupefySpellItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				StupefySpellEntity entityarrow = StupefySpellEntity.shoot(world, entity, world.getRandom(), 1f, 0.5, 5);
