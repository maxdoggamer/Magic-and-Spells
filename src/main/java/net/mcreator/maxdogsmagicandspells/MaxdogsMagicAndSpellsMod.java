 ...
 *
 */
package net.mcreator.maxdogsmagicandspells;
...
@Mod("maxdogs_magic_and_spells")
public class MaxdogsMagicAndSpellsMod {
	public static final Logger LOGGER = LogManager.getLogger(MaxdogsMagicAndSpellsMod.class);
	public static final String MODID = "maxdogs_magic_and_spells";

	public MaxdogsMagicAndSpellsMod() {
		...
		MaxdogsMagicAndSpellsModMobEffects.REGISTRY.register(bus);
